...
from apps.video_transcoding_off.transcoding import profiles, metadata, workspace
        ...
        return metadata.Metadata(
            ...
            videos=[
                VideoMeta(
                    ...
                    device=None,
                    scenes=[
                        Scene(stream="v", duration=TS(s), start=TS(0), position=TS(0))
                        for s in scenes
                    ],
                ),
            ],
            audios=[
                AudioMeta(
                    ...
                    duration=TS(duration),
                    scenes=[
                        Scene(stream="a", duration=TS(s), start=TS(0), position=TS(0))
                        for s in scenes
                    ],
                ),
            ],
