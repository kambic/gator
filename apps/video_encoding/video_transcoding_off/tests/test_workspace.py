...
from apps.video_transcoding_off.transcoding import workspace
...
class FileSystemWorkspaceTestCase(TestCase):
    ...
    @mock.patch(
        "builtins.open", new_callable=partial(mock.mock_open, read_data="read_data")
    )
...
class WebDAVWorkspaceTestCase(TestCase):
    def setUp(self):
        ...
        self.status_patcher = mock.patch.object(self.response, "raise_for_status")
    ...
    def test_ensure_collection(self):
        ...
        self.session_mock.assert_has_calls(
            [
                ...
                mock.call("MKCOL", "https://domain.com/path/another/collection/", **kw),
            ]
        )
    ...
    def test_delete_collection(self):
        ...
        self.session_mock.assert_has_calls(
            [
                mock.call(
                    "DELETE",
                    "https://domain.com/path/another/collection/",
                    **self.session_kwargs,
                )
            ]
        )
    ...
    def test_exists(self):
        ...
        self.session_mock.assert_has_calls(
            [
                mock.call(
                    "HEAD",
                    "https://domain.com/path/first/second/file.txt",
                    **self.session_kwargs,
                ),
            ]
        )
        ...
        self.session_mock.assert_has_calls(
            [
                mock.call(
                    "HEAD",
                    "https://domain.com/path/first/second/dir/",
                    **self.session_kwargs,
                ),
            ]
        )
