...
from apps.video_transcoding_off import forms
from apps.video_transcoding_off import helpers
from apps.video_transcoding_off import models

C = TypeVar("C", bound=Callable)


def short_description(name: str | Promise) -> Callable[[C], C]:
...
class VideoAdmin(admin.ModelAdmin):
    ...
    def transcode(
        self, request: HttpRequest, queryset: "QuerySet[models.Video]"
    ) -> None:
