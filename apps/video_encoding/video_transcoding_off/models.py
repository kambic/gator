...
# from  apps.video_transcoding import defaults
...
class VideoTrackBase(TimeStampedModel):
    ...
    preset = models.ForeignKey(
        Preset, models.CASCADE, related_name="video_tracks", verbose_name=_("preset")
    )
...
class AudioTrackBase(TimeStampedModel):
    ...
    params = models.JSONField(verbose_name=_("params"), default=dict)
    preset = models.ForeignKey(
        Preset, models.CASCADE, related_name="audio_tracks", verbose_name=_("preset")
    )
...
class VideoProfileBase(TimeStampedModel):
    ...
    preset = models.ForeignKey(
        Preset, models.CASCADE, related_name="video_profiles", verbose_name=_("preset")
    )
    ...
    video = cast(
        ...
        models.ManyToManyField(
            VideoTrack, verbose_name=_("Video tracks"), through="VideoProfileTracks"
        ),
    )
...
class AudioProfileBase(TimeStampedModel):
    ...
    condition = models.JSONField(verbose_name=_("condition"), default=dict)
    preset = models.ForeignKey(
        Preset, models.CASCADE, related_name="audio_profiles", verbose_name=_("preset")
    )

    audio = cast(
        related_descriptors.ManyToManyDescriptor,
        models.ManyToManyField(
            AudioTrack, verbose_name=_("Audio tracks"), through="AudioProfileTracks"
        ),
    )
...
class Video(TimeStampedModel):
    ...
    status = models.SmallIntegerField(
        default=CREATED, choices=STATUS_CHOICES, verbose_name=_("Status")
    )
    error = models.TextField(blank=True, null=True, verbose_name=_("Error"))
    task_id = models.UUIDField(blank=True, null=True, verbose_name=_("Task ID"))
    ...
    preset = models.ForeignKey(
        Preset, models.SET_NULL, verbose_name=_("preset"), blank=True, null=True
    )
    ...
    def format_video_url(self, edge: str) -> str:
        ...
        return defaults.VIDEO_URL.format(edge=edge.rstrip("/"), filename=basename.hex)
